...
| ファイルパス                    | 種別               | 補足                                                |
|--------------------------------|--------------------|----------------------------------------------------|
| `samples/caesar/ciphertext.txt`    | シーザー暗号       | 単一換字式暗号であり、カシスキー法は不適切。        |
| `samples/shift/ciphertext.txt`     | シフト暗号         | 同上。                                           |
| `samples/vigenere1/ciphertext.txt` | ヴィジュネル暗号   | 短い鍵で周期的なパターンが現れやすい。              |
| `samples/vigenere2/ciphertext.txt` | ヴィジュネル暗号   | 長文（約5000文字）で鍵も長め。                     |
| `samples/random/random.txt`        | ランダム文字列     | 反復パターンが自然に生じるかどうかの確認に使用可能。 |
